...
<?php if($page_layout == 'left'): get_sidebar(); endif; ?>
			<div id="content" class="<?php if($page_layout == 'full'): echo 'grid_12 grid-100'; else: echo 'grid_8 grid-66'; endif; ?> <?php if($page_layout == 'left'): echo 'omega'; else: echo 'alpha'; endif; ?> single single-sermon">
...
<?php endif; ?>
					<?php if ( function_exists('mejs_audio_shortcode') ) : ?>
						<?php echo do_shortcode( '[mejsaudio src="' . esc_url($sm_audio_file) . '"]' ) ?>
...
<?php if($sm_audio_button_text && $sm_audio_file): ?>
						<li><a href="<?php echo add_query_arg( array( 'ct_download' => $sm_audio_file ), get_permalink() ) ?>" class="button" title="<?php _e('Download','churchthemes'); ?> <?php echo $sm_audio_button_text; ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/icon-download.png"><?php echo $sm_audio_button_text; ?></a></li>
<?php endif; ?>
<?php if($sm_video_button_text && $sm_video_file): ?>
						<li><a href="<?php echo add_query_arg( array( 'ct_download' => $sm_video_file ), get_permalink() ) ?>" class="button" title="<?php _e('Download','churchthemes'); ?> <?php echo $sm_video_button_text; ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/icon-download.png"><?php echo $sm_video_button_text; ?></a></li>
<?php endif; ?>
<?php if($sm_sg_button_text && $sm_sg_file): ?>
						<li><a href="<?php echo add_query_arg( array( 'ct_download' => $sm_sg_file ), get_permalink() ) ?>" class="button" title="<?php _e('Download','churchthemes'); ?> <?php echo $sm_sg_button_text; ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/icon-download.png"><?php echo $sm_sg_button_text; ?></a></li>
<?php endif; ?>
					</ul>
				</div>
<?php endif; ?>
